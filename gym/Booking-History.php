...
where t1.userid=:uid";
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a href="booking-details.php?bookingid=<?php echo htmlentities($result->bookingid);?>"><button class="btn btn-primary" type="button" style="background-color:purple;border-color:purple">View</button></td>
                  </tr>
                    <?php  $cnt=$cnt+1; } } ?>
